...
if [ -n "$WAYLAND_DISPLAY" ]; then
    ...
    # Use -x flag or it will not displaying after refrehsing wm
    rm -f $WOBSOCK && mkfifo $WOBSOCK && pgrep -x $WOBSOCK > /dev/null || tail -f $WOBSOCK | wob &
